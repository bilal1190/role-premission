<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('roles.store') }}" class="bg-slate-700 hover:bg-slate-600 text-sm rounded-md text-white px-3 py-3">Back</a>
        </div>
    </x-slot>
    <div class="py-12">
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.index') }}" method="post">
                        ...
                        <div>
                            ...
                            <button
                                class="bg-slate-700 hover:bg-slate-600 text-sm rounded-md text-white px-5 py-3">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
